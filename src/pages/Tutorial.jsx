...
import PageHeader from '../components/PageHeader'; // Make sure this import is present
import './Tutorial.css'; 
...
// --- FIX 1: Add onMenuToggle as a prop ---
function Tutorial({ onMenuToggle }) {
    return (
        <div className="tutorial-page-container">
            {/* --- FIX 2: Add the PageHeader component here --- */}
            <PageHeader title="How to Use" onMenuToggle={onMenuToggle} />
